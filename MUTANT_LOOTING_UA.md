...
Одноразовий particle живе незалежно від HUD Controller. Після завершення
`time_limit` припиняється лише емісія, а вже створені частинки дограють власний
lifetime до кінця; завершення анімації, звуку чи самого looting lifecycle їх не
обриває.
