...
enum { sg_Undefined = 0, sg_SourceType = u32(-1), sg_forcedword = u32(-1) };
enum { sm_Looped = (1ul << 0ul), sm_2D = (1ul << 1ul), sm_forcedword = u32(-1) };
enum esound_type { st_Effect = 0, st_Music = 1, st_forcedword = u32(-1) };
...
public:
    u32 _rendered, _simulated, _cache_hits, _cache_misses, _events;
};
