...
void CPHIsland::Enable() {
    ...
    for (dxBody* body = DWorld()->firstbody; body != nullptr; body = static_cast<dxBody*>(body->next)) {
...
void CPHIsland::Repair() {
    ...
    for (dxBody* body = firstbody; body != nullptr; body = static_cast<dxBody*>(body->next)) {
