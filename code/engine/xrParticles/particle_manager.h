...
public:
    ...
    [[nodiscard]] ParticleEffect* GetEffectPtr(int effect_id);
    [[nodiscard]] ParticleActions* GetActionListPtr(int alist_id);
    ...
    // action
    [[nodiscard]] virtual ParticleAction* CreateAction(PActionEnum action_id);
