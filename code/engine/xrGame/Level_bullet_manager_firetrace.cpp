...
//								(äëÿ ïðîñ÷åòà ñòîëêíîâåíèé è èõ
//âèçóàëèçàöèè)
//////////////////////////////////////////////////////////////////////
                ...
                if (actor && IsGameTypeSingle() /**/ || stalker /**/) {
                    ...
                    if (Fsphere::rpNone !=
                        ...
                        if (actor) {
                            ...
                            // åñëè ñòðåëÿë ñòàëêåð, ó÷èòûâàåì - hit_probability_factor ñòàëêåða
                            // èíà÷å - 1.0
                            if (i_stalker) {
...
bool CBulletManager::ObjectHit(SBullet_Hit* hit_res, SBullet* bullet, const Fvector& end_point,
    ...
    *hit_res = bullet->hit_param; // default param
    ...
    if ((f < ricoshet_factor) && !mtl->Flags.test(SGameMtl::flNoRicoshet) &&
        ...
        // óìåíüøåíèå ñêîðîñòè ïîëåòà â çàâèñèìîñòè îò óãëà ïàäåíèÿ ïóëè (÷åì ïðÿìåå óãîë, òåì
        // áîëüøå ïîòåðÿ)
